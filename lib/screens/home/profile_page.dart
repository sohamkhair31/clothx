...
Container(
  ...
  decoration: BoxDecoration(
    color: NVColors.gold.withOpacity(.15),
...
class _OrderCardState extends State<_OrderCard> {
  ...
  Widget _desktopHeader(OrderModel o) {
    return Row(
      children: [
        _thumb(o),
        const SizedBox(width: 16),
        Expanded(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(o.items.first.name,
                  style: const TextStyle(
                      color: NVColors.ivory,
                      fontSize: 14.5,
                      fontWeight: FontWeight.w600)),
              const SizedBox(height: 4),
              Text('${o.orderId}  \u00b7  ${DateFormat("dd MMM yyyy").format(o.createdAt)}',
        ...
        Expanded(
          ...
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              NVStatusBadge(status: getOrderStatus(o.orderStatus)),
              const SizedBox(height: 6),
              Text(o.orderStatus,
                  style: const TextStyle(color: NVColors.softGray, fontSize: 11.5)),
            ],
        ...
        Expanded(
          flex: 1,
          child: Text('\$${o.totalAmount.toStringAsFixed(2)}',
  ...
  Widget _mobileHeader(OrderModel o) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
  ...
  Widget _orderActions(OrderModel o) {
    return Wrap(
      spacing: 8,
      runSpacing: 8,
      children: [
  ...
  Widget _expandedDetails(OrderModel o) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 14),
          Text('${o.items.length} item${o.items.length > 1 ? 's' : ''} in this order',
              style: const TextStyle(color: NVColors.softGray, fontSize: 12.5)),
          const SizedBox(height: 10),
          _timelineRow(Icons.receipt_rounded, 'Order placed', DateFormat("dd MMM yyyy").format(o.createdAt), true),
          _timelineRow(Icons.inventory_2_rounded, 'Processing', DateFormat("dd MMM yyyy").format(o.createdAt), true),
          _timelineRow(
            Icons.local_shipping_rounded,
            'Shipped',
            getOrderStatus(o.orderStatus) == OrderStatus.processing ? 'Pending' : DateFormat("dd MMM yyyy").format(o.createdAt),
getOrderStatus(o.orderStatus) == OrderStatus.processing
          ),
          _timelineRow(
            Icons.home_rounded,
            'Delivered',
            getOrderStatus(o.orderStatus) == OrderStatus.delivered ? o.orderStatus : 'Pending',
getOrderStatus(o.orderStatus) == OrderStatus.delivered
          ),
        ],
      ),
    );
